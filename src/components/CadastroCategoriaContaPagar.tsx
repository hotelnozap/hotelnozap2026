...
export interface CadastroCategoriaContaPagarProps {
  onBack?: () => void;
  onSaveSuccess?: () => void;
}

export const CadastroCategoriaContaPagar: React.FC<CadastroCategoriaContaPagarProps> = ({
  onBack,
  onSaveSuccess,
}) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await categoriasService.createCategoriaContaPagar(nome, descricao);
    ...
    <div className="p-4 sm:p-8 lg:p-10 w-full max-w-3xl mx-auto flex flex-col gap-6 pb-24 lg:pb-12 text-slate-800 font-sans antialiased">
      ...
      {onBack && (
        <div>
          ...
          >
            ...
            <span>Voltar para Categorias de Contas a Pagar</span>
          </button>
        </div>
      )}
      ...
      <header className="pb-2 border-b border-slate-200">
        ...
        <p className="text-xs sm:text-sm text-slate-500 mt-1">
          Preencha os dados da categoria para organização e controle das contas a pagar.
        </p>
      </header>
        ...
        <div className="bg-white rounded-2xl p-5 sm:p-6 border border-slate-200/80 shadow-xs space-y-5">
            ...
            <div className="sm:col-span-2 space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="Ex: Energia Elétrica & Água, Manutenção Predial..."
                  ...
                  required
                />
                <span className="material-symbols-outlined absolute left-3 top-2.5 text-slate-400 text-lg">label</span>
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  required
                />
                <span className="material-symbols-outlined absolute left-3 top-2.5 text-slate-400 text-lg">format_list_numbered</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              placeholder="Descreva o tipo de compromisso ou despesas que serão alocadas nesta categoria..."
...
export default CadastroCategoriaContaPagar;
