...
export interface CategoriaContaPagarItem {
  id: string;
  code: string;
  name: string;
  description: string;
...
export interface CategoriasContasPagarProps {
  onBack: () => void;
  onNavigateToNovaCategoria?: () => void;
}

const INITIAL_CATEGORIAS_DESPESAS: CategoriaContaPagarItem[] = [];

export const CategoriasContasPagar: React.FC<CategoriasContasPagarProps> = ({
  onBack,
  onNavigateToNovaCategoria,
}) => {
  const [categories, setCategories] = useState<CategoriaContaPagarItem[]>(INITIAL_CATEGORIAS_DESPESAS);
  ...
  // Modals
  const [selectedCatForView, setSelectedCatForView] = useState<CategoriaContaPagarItem | null>(null);
  const [selectedCatForEdit, setSelectedCatForEdit] = useState<CategoriaContaPagarItem | null>(null);
  const [catToDelete, setCatToDelete] = useState<CategoriaContaPagarItem | null>(null);
  ...
  const totalDespesasGlobal = useMemo(() => {
  ...
  const handleCreateSubmit = (e: React.FormEvent) => {
    ...
    const newCat: CategoriaContaPagarItem = {
      id: newId,
      code: nextCode,
      name: formName.trim(),
      description: formDesc.trim() || 'Descrição da nova categoria de despesas.',
  ...
  const openEdit = (cat: CategoriaContaPagarItem) => {
    ...
    <div className="bg-[#f8f9fc] min-h-screen p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-6 pb-28 sm:pb-12 text-slate-800 font-sans antialiased">
      ...
      <div className="flex flex-col gap-0.5 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
            Gerencie as categorias de despesas, agrupamentos financeiros e centros de custos.
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-4">
        ...
        <div className="bg-indigo-50/80 rounded-xl p-3.5 sm:p-5 border border-indigo-200/70 shadow-2xs flex flex-col justify-between">
          <div className="flex items-start justify-between gap-1">
            <div>
              <span className="text-[10px] sm:text-xs uppercase font-bold text-indigo-700 tracking-wider">Total em Despesas</span>
              <div className="mt-1 text-sm sm:text-xl font-extrabold text-indigo-900 whitespace-nowrap tracking-tight">
                R$ {totalDespesasGlobal.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
              </div>
            </div>
          ...
          <div className="mt-2 pt-2 border-t border-indigo-200/50 flex items-center justify-between text-[10px] sm:text-xs text-indigo-600 font-medium">
            <span>Acumulado</span>
            <span className="font-bold">Contas a Pagar</span>
          </div>
        </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50/80 border-b border-slate-200 text-[11px] font-extrabold uppercase tracking-wider text-slate-500">
                  ...
                  <th className="py-3 px-4 text-right">Total em Despesas</th>
              ...
              >
                ...
                <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-xs">
                  ...
                  <div className="text-right">
                    <span className="text-[10px] text-slate-400 block font-semibold uppercase">Total Despesas</span>
            ...
            <div className="px-6 py-4 bg-[#003400] text-white flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <h3 className="font-bold text-white text-base">
                  {selectedCatForEdit ? 'Editar Categoria' : 'Nova Categoria de Despesa'}
                </h3>
              </div>
              <button
                type="button"
            ...
            <form onSubmit={selectedCatForEdit ? handleEditSubmit : handleCreateSubmit} className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Ex: Manutenção Predial, Marketing..."
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Descreva o tipo de despesas associadas..."
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  >
                    ...
                    <option value="bolt">Bolt (Energia)</option>
                    <option value="build">Build (Manutenção)</option>
                    <option value="inventory_2">Inventory (Fornecedores)</option>
                    <option value="dry_cleaning">Dry Cleaning (Lavanderia)</option>
                    <option value="badge">Badge (Folha/RH)</option>
                    <option value="account_balance">Bank (Impostos)</option>
...
export default CategoriasContasPagar;
